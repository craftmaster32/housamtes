...
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------- |
| Custom email sender (SMTP)                 | Verification emails come **from "HouseMates"** instead of Supabase's shared address, with better deliverability (won't land in spam). Foundation for the two items below. See `supabase/email-templates/README.md` step 3 (Resend + SMTP, ~20–30 min). | Owning a domain (~$10–15/yr) |
