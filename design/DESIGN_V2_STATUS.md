...
| **Bills** (merged balance + tap-to-reveal settle) | `bills-flow-v2`, `bills-v2`, `addbill-v2`                                | ⬜     | biggest owner complaint — do first                           |
| Dashboard                                         | `nestiq-v2-dashboard`, `nestiq-v2-final`                                 | ⬜     |                                                              |
